<template>
  <div class="coursesample mb-5 sm:mb-4">
    <div class="card relative clickable flex w-fit whatis pr-3 m-0-auto">
      <div
        class="hidden absolute mt-1 mr-2 btn-mod z-30 right-0 top-0 flex align-center space-x-2"
      >
      ...
      <div class="relative hkho ml-4">
        <div
          class="hidden absolute mt-3 btn-mode z-30 right-0 top-0 flex align-center space-x-2"
        >
          <button class="no-outlines hover-008489 outline-none">
            <client-only>
              <svg
