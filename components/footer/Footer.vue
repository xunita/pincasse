<template>
  <div>
    <div>
      <client-only>
        <a
          class="dropdown-item clickable px-8 flex align-center space-x-3 py-2"
          @click="
            {
              lang = !lang
            }
      ...
      <div v-show="lang" class="lang-foot font-semibold px-8">
        <nuxt-link
